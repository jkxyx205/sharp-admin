...
//                        new QueryField("material_id", "物料", QueryField.Type.TEXT),
                        ...
                        new QueryField("type", "场景", QueryField.Type.SELECT, "inv_type"),
